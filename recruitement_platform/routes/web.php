    ...
    // Pour afficher toutes les offres aux candidats
    Route::get('/candidat/get-all-jobs', [JobController::class, 'allJobs'])->name('candidat.jobs.all');

    // Pour sauvegarder une offre
    ...
    // Route::get('/candidat/candidatures', [CandidatureController::class, 'index'])->name('dashboard.recruteur.candidatures');

    // Route::get('/candidat/{id}', [CandidatController::class, 'show'])->name('candidat.info');